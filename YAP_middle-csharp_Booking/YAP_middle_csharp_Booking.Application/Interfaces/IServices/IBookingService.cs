...
namespace YAP_middle_csharp_Booking.Application.Interfaces.IServices
{
    public interface IBookingService
    {
        ...
        Task<IEnumerable<BookingModel>> FindPendingBookingAsync(CancellationToken cancellationToken = default);
        ...
        Task<BookingModel?> FindByIdForUserAsync(Guid id, Guid idUserFromRequest, UserRoleEnum userRole, CancellationToken cancellationToken = default);
        ...
        Task<BookingModel> CreateBookingAsync(Guid eventId, Guid userId, int seatsCount = 1, CancellationToken cancellationToken = default);
        ...
        Task CancelledBookingAsync(Guid eventId, Guid bookingId, Guid currentUserId, UserRoleEnum currentUserRole, CancellationToken cancellationToken = default);
        ...
        Task DeleteAsync(BookingModel bookingModel, CancellationToken cancellationToken = default);
